...
# from torch._six import int_classes as _int_classes    # error
...
class RoiDataLoader(data.Dataset):
    def __init__(self, roidb, num_classes,flag , training=True):
        self._roidb = roidb
    ...
    def __getitem__(self, index_tuple):
        ...
        blobs, valid = get_minibatch(single_db, self._num_classes, self.flag)
