...
def load_pretrained_imagenet_weights(model):
    ...
    print("Load pre-trained weight for vgg !!")
...
def convert_state_dict(src_dict):
    ...
    try:
        ...
        dst_dict['fc1.weight'] = src_dict['classifier.0.weight']#.t()
        dst_dict['fc1.bias'] = src_dict['classifier.0.bias']
        dst_dict['fc2.weight'] = src_dict['classifier.3.weight']#.t()
        dst_dict['fc2.bias'] = src_dict['classifier.3.bias']
    except:
        dst_dict['conv1.0.weight'] = src_dict['0.features.0.weight']
        dst_dict['conv1.0.bias'] = src_dict['0.features.0.bias']
        dst_dict['conv1.2.weight'] = src_dict['0.features.2.weight']
        dst_dict['conv1.2.bias'] = src_dict['0.features.2.bias']
        dst_dict['conv2.0.weight'] = src_dict['0.features.5.weight']
        dst_dict['conv2.0.bias'] = src_dict['0.features.5.bias']
        dst_dict['conv2.2.weight'] = src_dict['0.features.7.weight']
        dst_dict['conv2.2.bias'] = src_dict['0.features.7.bias']
        dst_dict['conv3.0.weight'] = src_dict['0.features.10.weight']
        dst_dict['conv3.0.bias'] = src_dict['0.features.10.bias']
        dst_dict['conv3.2.weight'] = src_dict['0.features.12.weight']
        dst_dict['conv3.2.bias'] = src_dict['0.features.12.bias']
        dst_dict['conv3.4.weight'] = src_dict['0.features.14.weight']
        dst_dict['conv3.4.bias'] = src_dict['0.features.14.bias']
        dst_dict['conv4.0.weight'] = src_dict['0.features.17.weight']
        dst_dict['conv4.0.bias'] = src_dict['0.features.17.bias']
        dst_dict['conv4.2.weight'] = src_dict['0.features.19.weight']
        dst_dict['conv4.2.bias'] = src_dict['0.features.19.bias']
        dst_dict['conv4.4.weight'] = src_dict['0.features.21.weight']
        dst_dict['conv4.4.bias'] = src_dict['0.features.21.bias']
        dst_dict['conv5.0.weight'] = src_dict['0.features.24.weight']
        dst_dict['conv5.0.bias'] = src_dict['0.features.24.bias']
        dst_dict['conv5.2.weight'] = src_dict['0.features.26.weight']
        dst_dict['conv5.2.bias'] = src_dict['0.features.26.bias']
        dst_dict['conv5.4.weight'] = src_dict['0.features.28.weight']
        dst_dict['conv5.4.bias'] = src_dict['0.features.28.bias']
        # dst_dict['fc1.weight'] = src_dict['classifier.0.weight']#.t()
        # dst_dict['fc1.bias'] = src_dict['classifier.0.bias']
        # dst_dict['fc2.weight'] = src_dict['classifier.3.weight']#.t()
        # dst_dict['fc2.bias'] = src_dict['classifier.3.bias']
