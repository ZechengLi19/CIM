...
class RoIPoolFunction(Function):
    ...
    def forward(ctx, features, rois): 
        ...
        batch_size, num_channels, data_height, data_width = ctx.feature_size  # 1, 512, 57, 86
        num_rois = rois.size(0)     # 1019
        output = features.new(num_rois, num_channels, ctx.pooled_height, ctx.pooled_width).zero_()  # 1019, 512, 7, 7
