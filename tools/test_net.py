...
def parse_args():
    ...
    parser.add_argument(
        '--load_ckpt', default='Outputs/vgg16_cobsbd/Jul18-13-35-47_omnisky_step/ckpt/model_step44999.pth',
...
if __name__ == '__main__':
    ...
    #cfg.TEST.PROPOSAL_FILES = ('data/selective_search_data/voc_2012_test.pkl',)
    ...
    run_inference(
        args,
        ind_range=args.range,  # ind_range = None, --> is_parent = True
        multi_gpu_testing=args.multi_gpu_testing,  # False
